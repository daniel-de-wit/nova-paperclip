...
/* scopeId */
var __vue_scopeId__ = "data-v-95792408"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "nova/resources/js/components/ImageLoader.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-95792408", Component.options)
  } else {
    hotAPI.reload("data-v-95792408", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
Nova.booting(function (Vue, router) {
    Vue.component('index-paperclip-file', __webpack_require__(15));
    Vue.component('detail-paperclip-file', __webpack_require__(16));
    Vue.component('form-paperclip-file', __webpack_require__(25));

    Vue.component('index-paperclip-image', __webpack_require__(15));
    Vue.component('detail-paperclip-image', __webpack_require__(16));
    Vue.component('form-paperclip-image', __webpack_require__(25));

    Vue.component('index-paperclip-video', __webpack_require__(15));
    Vue.component('detail-paperclip-video', __webpack_require__(16));
    Vue.component('form-paperclip-video', __webpack_require__(25));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__nova_resources_js_components_ImageLoader__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__nova_resources_js_components_ImageLoader___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__nova_resources_js_components_ImageLoader__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: { ImageLoader: __WEBPACK_IMPORTED_MODULE_1__nova_resources_js_components_ImageLoader___default.a },
...
var update = __webpack_require__(51)("1b044616", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../../nova-components/Paperclip/node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-95792408\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../nova-components/Paperclip/node_modules/vue-loader/lib/selector.js?type=styles&index=0!./ImageLoader.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../../nova-components/Paperclip/node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-95792408\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../nova-components/Paperclip/node_modules/vue-loader/lib/selector.js?type=styles&index=0!./ImageLoader.vue");
...
var _laravelNova = __webpack_require__(90);
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-95792408", module.exports)
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__nova_resources_js_components_ImageLoader__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__nova_resources_js_components_ImageLoader___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__nova_resources_js_components_ImageLoader__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__nova_resources_js_components_DeleteButton__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__nova_resources_js_components_DeleteButton___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__nova_resources_js_components_DeleteButton__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_laravel_nova__ = __webpack_require__(97);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: { DeleteButton: __WEBPACK_IMPORTED_MODULE_2__nova_resources_js_components_DeleteButton___default.a, ImageLoader: __WEBPACK_IMPORTED_MODULE_1__nova_resources_js_components_ImageLoader___default.a },
    ...
    computed: {
        hasRules: function hasRules() {
            return this.rulesMessages.length;
        },
        rulesMessages: function rulesMessages() {
            var rules = [];

            if (this.field.mimes && this.field.mimes.length) {
                rules.push('Filetypes: ' + this.field.mimes.join(', '));
            }

            if (this.field.min) {
                rules.push('Min ' + this.field.min + ' kb');
            }

            if (this.field.max) {
                rules.push('Max ' + this.field.max + ' kb');
            }

            if (this.field.size) {
                rules.push('Exact ' + this.field.size + ' kb');
            }

            if (this.field.minHeight) {
                rules.push('Min height ' + this.field.minHeight + 'px');
            }

            if (this.field.height) {
                rules.push('Exact height ' + this.field.height + 'px');
            }

            if (this.field.maxHeight) {
                rules.push('Max height ' + this.field.maxHeight + 'px');
            }

            if (this.field.minWidth) {
                rules.push('Min width ' + this.field.minWidth + 'px');
            }

            if (this.field.width) {
                rules.push('Exact width ' + this.field.width + 'px');
            }

            if (this.field.maxWidth) {
                rules.push('Max width ' + this.field.maxWidth + 'px');
            }
...
Component.options.__file = "nova/resources/js/components/DeleteButton.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6807c302", Component.options)
  } else {
    hotAPI.reload("data-v-6807c302", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6807c302", module.exports)
  }
}
    ...
    [
      _c("template", { slot: "field" }, [
        ...
        _vm.hasRules
          ? _c(
              "ul",
              { staticClass: "text-80 text-xs pb-4" },
              _vm._l(_vm.rulesMessages, function(message) {
                return _c("li", [
                  _vm._v(
                    "\n                " + _vm._s(message) + "\n            "
                  )
